 ...
 *
 * È diverso da GetAllIslandsStatisticsUseCase che gestisce
...
class GetIslandStatisticsUseCase @Inject constructor(
     ...
     */
    private fun calculateOperationalStats(island: Island, currentTime: Instant): OperationalStats {
     ...
     * Calcola stato manutenzione
     */
    private fun calculateMaintenanceStats(island: Island, currentTime: Instant): MaintenanceStats {
     ...
     * Calcola stato garanzia
     */
    private fun calculateWarrantyStats(island: Island, currentTime: Instant): WarrantyStats {
