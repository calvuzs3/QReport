...
class DeleteIslandUseCase @Inject constructor(
    ...
    suspend operator fun invoke(islandId: String, force: Boolean = false): Result<Unit> {
        return try {
            ...
            islandRepository.deleteIsland(islandId)
    ...
    private suspend fun checkPreDeletionConditions(
        ...
        return try {
            ...
            val siblingIslands = islandRepository.getIslandsByFacility(island.facilityId)
                .getOrElse { emptyList() }
    ...
    suspend fun countRemainingIslandsAfterDeletion(islandId: String): Result<Int> {
        return try {
            ...
            val currentCount = islandRepository.getIslandsCountByFacility(island.facilityId)
                .getOrElse { return Result.failure(it) }
