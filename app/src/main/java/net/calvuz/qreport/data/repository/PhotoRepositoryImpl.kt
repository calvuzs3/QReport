...
import net.calvuz.qreport.data.mapper.toEntity
    ...
    override suspend fun getPhotosSummary(): PhotoSummary {
        ...
        return if (statistics != null) {
            PhotoSummary(
                ...
                oldestPhoto = Instant.fromEpochMilliseconds(statistics.oldestTimestamp),
                newestPhoto = Instant.fromEpochMilliseconds(statistics.newestTimestamp),
