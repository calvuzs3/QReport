...
data class ClientListUiState(
    ...
    val sortOrder: SortOrder = SortOrder.COMPANY_NAME
)
...
class ClientListViewModel @Inject constructor(
    ...
    private fun applyFiltersAndSort(
        ...
        filtered = when (sortOrder) {
            SortOrder.COMPANY_NAME -> filtered.sortedBy { it.client.companyName }
            SortOrder.CREATED_RECENT -> filtered.sortedByDescending { it.client.createdAt }
            SortOrder.CREATED_OLDEST -> filtered.sortedBy { it.client.createdAt }
            SortOrder.FACILITIES_COUNT -> filtered.sortedByDescending { it.stats.facilitiesCount }
            SortOrder.CHECKUPS_COUNT -> filtered.sortedByDescending { it.stats.totalCheckUps }
        }
