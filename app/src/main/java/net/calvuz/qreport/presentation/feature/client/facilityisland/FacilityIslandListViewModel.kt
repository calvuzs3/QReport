...
import net.calvuz.qreport.domain.usecase.client.facilityisland.SearchFacilityIslandsUseCase
 ...
 */
@HiltViewModel
class FacilityIslandListViewModel @Inject constructor(
    private val getIslandsByFacilityUseCase: GetFacilityIslandsByFacilityUseCase,
    private val searchIslandsUseCase: SearchFacilityIslandsUseCase,
     ...
     * Calcola statistiche semplici localmente
     */
    private fun calculateSimpleStats(islands: List<FacilityIsland>): FacilityOperationalSummary {
...
data class FacilityIslandListUiState(
    ...
    val searchSuggestions: List<FacilityIsland> = emptyList(),
