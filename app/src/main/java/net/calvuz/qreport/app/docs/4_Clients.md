...
class GetClientWithDetailsUseCase @Inject constructor(
    ...
    private val islandRepository: FacilityIslandRepository
) {
...
class AddFacilityIslandUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        val existingIsland = islandRepository.getIslandBySerialNumber(serialNumber)
        ...
        val islandId = islandRepository.createIsland(island)
