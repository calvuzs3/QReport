...
fun QrError.ValidationError.toUiText(): UiText {
    return when (this) {
        is QrError.ValidationError.IdsDoesntMatch -> StringResources(R.string.err_validation_ids_doesnt_match)
...
fun QrError.asUiText(): UiText {
    return when (this) {
        ...
        QrError.FileError.DIRECTORY_CREATE -> StringResources(R.string.err_file_directory_create)

        QrError.FileError.DIRECTORY_ACCESS -> StringResources(R.string.err_file_directory_access)

        QrError.FileError.DIRECTORY_DELETE -> StringResources(R.string.err_file_directory_delete)

        QrError.FileError.DIRECTORY_NOT_FOUND -> StringResources(R.string.err_file_directory_not_found)

        QrError.FileError.DIRECTORY_NOT_EMPTY -> StringResources(R.string.err_file_directory_not_empty)

        QrError.FileError.DIRECTORY_PERMISSION_DENIED -> StringResources(R.string.err_file_directory_permission_denied)

        QrError.FileError.FILE_CREATE -> StringResources(R.string.err_file_create)

        QrError.FileError.FILE_READ -> StringResources(R.string.err_file_read)

        QrError.FileError.FILE_WRITE -> StringResources(R.string.err_file_write)

        QrError.FileError.FILE_DELETE -> StringResources(R.string.err_file_delete)

        QrError.FileError.FILE_COPY -> StringResources(R.string.err_file_copy)

        QrError.FileError.FILE_MOVE -> StringResources(R.string.err_file_move)

        QrError.FileError.FILE_RENAME -> StringResources(R.string.err_file_rename)

        QrError.FileError.FILE_ACCESS -> StringResources(R.string.err_file_access)

        QrError.FileError.FILE_NOT_FOUND -> StringResources(R.string.err_file_not_found)

        QrError.FileError.FILE_ALREADY_EXISTS -> StringResources(R.string.err_file_already_exists)

        QrError.FileError.FILE_LOCKED -> StringResources(R.string.err_file_locked)

        QrError.FileError.FILE_CORRUPTED -> StringResources(R.string.err_file_corrupted)

        QrError.FileError.PERMISSION_DENIED -> StringResources(R.string.err_file_permission_denied)

        QrError.FileError.READ_PERMISSION_DENIED -> StringResources(R.string.err_file_read_permission_denied)

        QrError.FileError.WRITE_PERMISSION_DENIED -> StringResources(R.string.err_file_write_permission_denied)

        QrError.FileError.EXECUTE_PERMISSION_DENIED -> StringResources(R.string.err_file_execute_permission_denied)

        QrError.FileError.INSUFFICIENT_SPACE -> StringResources(R.string.err_file_insufficient_space)

        QrError.FileError.DISK_FULL -> StringResources(R.string.err_file_disk_full)

        QrError.FileError.STORAGE_UNAVAILABLE -> StringResources(R.string.err_file_storage_unavailable)

        QrError.FileError.QUOTA_EXCEEDED -> StringResources(R.string.err_file_quota_exceeded)

        QrError.FileError.FILE_EMPTY -> StringResources(R.string.err_file_empty)
        QrError.FileError.FILE_TOO_LARGE -> StringResources(R.string.err_file_too_large)

        QrError.FileError.FILE_TOO_SMALL -> StringResources(R.string.err_file_too_small)

        QrError.FileError.SIZE_LIMIT_EXCEEDED -> StringResources(R.string.err_file_size_limit_exceeded)

        QrError.FileError.NAME_TOO_LONG -> StringResources(R.string.err_file_name_too_long)

        QrError.FileError.PATH_TOO_LONG -> StringResources(R.string.err_file_path_too_long)

        QrError.FileError.FORMAT_INVALID -> StringResources(R.string.err_file_format_invalid)

        QrError.FileError.ENCODING_ERROR -> StringResources(R.string.err_file_encoding_error)

        QrError.FileError.CHARSET_UNSUPPORTED -> StringResources(R.string.err_file_charset_unsupported)

        QrError.FileError.BINARY_DATA_CORRUPTED -> StringResources(R.string.err_file_binary_data_corrupted)

        QrError.FileError.IO_ERROR -> StringResources(R.string.err_file_io_error)

        QrError.FileError.READ_TIMEOUT -> StringResources(R.string.err_file_read_timeout)

        QrError.FileError.WRITE_TIMEOUT -> StringResources(R.string.err_file_write_timeout)

        QrError.FileError.OPERATION_INTERRUPTED -> StringResources(R.string.err_file_operation_interrupted)

        QrError.FileError.CONCURRENT_ACCESS -> StringResources(R.string.err_file_concurrent_access)

        QrError.FileError.NETWORK_UNAVAILABLE -> StringResources(R.string.err_file_network_unavailable)

        QrError.FileError.CONNECTION_LOST -> StringResources(R.string.err_file_connection_lost)

        QrError.FileError.EXTERNAL_STORAGE_REMOVED -> StringResources(R.string.err_file_external_storage_removed)

        QrError.FileError.DEVICE_BUSY -> StringResources(R.string.err_file_device_busy)

        QrError.FileError.PATH_INVALID -> StringResources(R.string.err_file_path_invalid)

        QrError.FileError.NAME_INVALID -> StringResources(R.string.err_file_name_invalid)

        QrError.FileError.EXTENSION_INVALID -> StringResources(R.string.err_file_extension_invalid)

        QrError.FileError.CHECKSUM_MISMATCH -> StringResources(R.string.err_file_checksum_mismatch)

        QrError.FileError.TEMP_FILE_CREATION_FAILED -> StringResources(R.string.err_file_temp_file_creation_failed)

        QrError.FileError.TEMP_DIR_UNAVAILABLE -> StringResources(R.string.err_file_temp_dir_unavailable)

        QrError.FileError.CACHE_WRITE_FAILED -> StringResources(R.string.err_file_cache_write_failed)

        QrError.FileError.CLEANUP_FAILED -> StringResources(R.string.err_file_cleanup_failed)

        QrError.FileError.FILE_LOCKED_BY_OTHER -> StringResources(R.string.err_file_locked_by_other)

        QrError.FileError.LOCK_ACQUISITION_FAILED -> StringResources(R.string.err_file_lock_acquisition_failed)

        QrError.FileError.UNLOCK_FAILED -> StringResources(R.string.err_file_unlock_failed)

        QrError.FileError.SYSTEM_ERROR -> StringResources(R.string.err_file_system_error)

        QrError.FileError.RESOURCE_UNAVAILABLE -> StringResources(R.string.err_file_resource_unavailable)

        QrError.FileError.HANDLE_EXHAUSTED -> StringResources(R.string.err_file_handle_exhausted)

        QrError.FileError.FILESYSTEM_ERROR -> StringResources(R.string.err_file_filesystem_error)

        QrError.FileError.FILESYSTEM_READONLY -> StringResources(R.string.err_file_filesystem_readonly)

        QrError.FileError.COPY_FAILED -> StringResources(R.string.err_file_copy_failed)

        QrError.FileError.MOVE_FAILED -> StringResources(R.string.err_file_move_failed)

        QrError.FileError.BACKUP_FAILED -> StringResources(R.string.err_file_backup_failed)

        QrError.FileError.RESTORE_FAILED -> StringResources(R.string.err_file_restore_failed)

        QrError.FileError.SYNC_FAILED -> StringResources(R.string.err_file_sync_failed)

        QrError.FileError.METADATA_READ_FAILED -> StringResources(R.string.err_file_metadata_read_failed)

        QrError.FileError.METADATA_WRITE_FAILED -> StringResources(R.string.err_file_metadata_write_failed)

        QrError.FileError.ATTRIBUTES_ACCESS_FAILED -> StringResources(R.string.err_file_attributes_access_failed)

        QrError.FileError.TIMESTAMP_UPDATE_FAILED -> StringResources(R.string.err_file_timestamp_update_failed)
        ...
        QrError.ShareError.FILEPROVIDER_FAILED -> StringResources(R.string.err_share_fileprovider_failed)
